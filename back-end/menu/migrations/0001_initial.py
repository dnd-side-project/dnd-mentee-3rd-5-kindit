# Generated by Django 3.0.2 on 2020-09-01 12:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.CharField(choices=[('서브웨이', '서브웨이'), ('베스킨라빈스', '베스킨라빈스'), ('스타벅스', '스타벅스'), ('공차', '공차')], max_length=64, null=True, verbose_name='브랜드')),
                ...
                ('rating', models.DecimalField(decimal_places=1, default=0.0, max_digits=5, verbose_name='평점')),
                ('hits', models.PositiveIntegerField(default=0, verbose_name='조회수')),
                ('comments', models.PositiveIntegerField(default='0', verbose_name='댓글수')),
                ('upload_image', models.ImageField(blank=True, null=True, upload_to='image_file/%Y/%m/%d', verbose_name='이미지파일')),
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='likes', to=settings.AUTH_USER_MODEL, verbose_name='찜')),
